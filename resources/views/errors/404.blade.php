...
<body>
    <div class="not-found w-full flex justify-center items-center py-20 flex-col">
        ...
        @if (auth()->check())
            <a class="inline-block font-semibold tracking-wider text-center rounded-md bg-gradient-to-br from-teal-400  to-sky-600 text-white py-1.5 px-3 hover:opacity-[90%]"
                href="{{ url('/main-users') }}">Back to home</a>
        @else
            <a class="inline-block font-semibold tracking-wider text-center rounded-md bg-gradient-to-br from-teal-400  to-sky-600 text-white py-1.5 px-3 hover:opacity-[90%]"
