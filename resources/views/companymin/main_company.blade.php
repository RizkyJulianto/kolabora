...
<div class="px-4 pt-6">
    ...
    <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
      ...
      <script src="{{ asset('library/layout_c/constants.js') }}"></script>  <div class="grid gap-4">
        <!-- Activity Card -->
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          <div class="flex items-center justify-between mb-4">
    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg mb-5 shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
      <!-- Card header -->
