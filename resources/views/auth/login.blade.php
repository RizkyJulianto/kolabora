...
<body class="font-primary">
    <section class="login-section flex flex-col lg:flex-row relative w-full h-dvh items-center overflow-hidden">
        <div class="left-col hidden lg:flex-1 bg-primary w-full h-full lg:flex items-center px-[6%] relative">
            <img class="w-full" src="{{ asset('images/auth/image-job.png') }}" alt="">
            {{-- <div class="swiper auth_swiper w-auto">
        ...
        <div class="right-col flex-1 py-28 lg:py-0 px-[6%] w-full relative">
            <div
            ...
            <p class="text-center mt-2 text-gray-500">Don't have an account? <a href="{{ url('auth/registrasi') }}"
